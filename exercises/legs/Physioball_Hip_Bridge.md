...
> 部位：腿臀　|　器械：瑜伽球　|　难度：⭐ 新手　|　类型：力量训练 · 复合动作 · 推
...
| 起始位 | 结束位 |
|:---:|:---:|
| <img src="../../assets/exercises/Physioball_Hip_Bridge/0.jpg" width="360"> | <img src="../../assets/exercises/Physioball_Hip_Bridge/1.jpg" width="360"> |

## 动作要点

1. 肩胛骨下缘卡在凳面边缘，双脚踩实地面，小腿在顶端应接近垂直。
2. 瑜伽球置于髋部（垫好软垫），下巴微收，视线看向前下方。
